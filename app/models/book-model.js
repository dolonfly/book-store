...
var BookSchema = new Schema({
    ...
    images: Schema.Types.Mixed,//图片  {"small":"http:\/\/img4.douban.com\/spic\/s4102527.jpg","large":"http:\/\/img4.douban.com\/lpic\/s4102527.jpg","medium":"http:\/\/img4.douban.com\/mpic\/s4102527.jpg"}
    catalog: String,//目录
    summary: String,//内容简介
    doubanId: String,//对应的豆瓣图书Id
